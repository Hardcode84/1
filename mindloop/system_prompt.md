...
This is not an interactive session, run until you're satisfied. If unsure about something you can ask the user using the ask tool, but they may not be immediately available. This session is finite and your token budget is limited, use the status tool to check how much you have left.
