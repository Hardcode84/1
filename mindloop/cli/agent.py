...
def _build_system_prompt(
    ...
    if paths.workspace and initial_messages is None:
        ...
        pinned_path = paths.workspace / "_pinned_turns.json"
        registry.write_blocked[pinned_path.resolve()] = "autogenerated between sessions"
        pinned = load_pinned_turns(pinned_path)
        if pinned:
